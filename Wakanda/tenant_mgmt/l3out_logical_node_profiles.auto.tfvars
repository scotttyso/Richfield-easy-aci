...
l3out_logical_node_profiles = {
  "inband_wakanda-leaf201-202" = {
    ...
    interface_profiles = [
      {
        ...
        description               = "142b-core01-02-l3out-vl201"
        encap_scope               = "local"
        encap_vlan                = 21
        ...
        svi_addresses = [
          {
            primary_preferred_address = "10.96.1.1/29"
            side                      = "A"
          },
          {
            primary_preferred_address = "10.96.1.2/29"
            side                      = "B"
          }
        ]
    ...
    nodes = [
      {
        node_id                   = 201
        router_id                 = "10.96.1.201"
        use_router_id_as_loopback = true
      },
      {
        node_id                   = 202
        router_id                 = "10.96.1.202"
        use_router_id_as_loopback = true
      }
    ]
    pod_id      = 1
